    ...
    public Queue<Node> operator(Node n)
    {
        ...
        if(var.separator[0].equals("clockwise"))
        {
            if(isValid(i, j+1)) // 1. Check if we can move one step right
            {
                ...
                else if(!set.contains(child) && n.getPath().charAt(n.getPath().length()-2)!='L')
                {
                    set.add(child);
                    ++created_states;
                    children.add(child);
            ...
            if(isValid(i+1, j+1)) // 2. Check if we can move right&down
            {
                ...
                else if(!set.contains(child)&& n.getPath().length()>=3&&!n.getPath().substring(n.getPath().length()-3, n.getPath().length()).equals("LU"))
                {
                    set.add(child);
                    ++created_states;
                    children.add(child);
            ...
            if(isValid(i+1, j)) // 3. Check if we can move one step down
            {
                ...
                else if(!set.contains(child)&& n.getPath().charAt(n.getPath().length()-2)!='U')
                {
                    set.add(child);
                    ++created_states;
                    children.add(child);
            ...
            if(isValid(i+1, j-1)) // 4. Check if we can move left&down
            {
                ...
                else if(!set.contains(child) && n.getPath().length()>=3&&!n.getPath().substring(n.getPath().length()-3, n.getPath().length()).equals("RU"))
                {
                    set.add(child);
                    ++created_states;
                    children.add(child);
            ...
            if(isValid(i, j-1)) // 5. Check if we can move one step left
            {
                ...
                else if(!set.contains(child) && n.getPath().charAt(n.getPath().length()-2)!='R')
                {
                    set.add(child);
                    ++created_states;
                    children.add(child);
            ...
            if(isValid(i-1, j-1)) // 6. Check if we can move left&up
            {
                ...
                else if(!set.contains(child) && n.getPath().length()>=3&&!n.getPath().substring(n.getPath().length()-3, n.getPath().length()).equals("RD"))
                {
                    set.add(child);
                    ++created_states;
                    children.add(child);
            ...
            if(isValid(i-1, j)) // 7. Check if we can move one step up
            {
                ...
                else if(!set.contains(child) && n.getPath().charAt(n.getPath().length()-2)!='D')
                {
                    set.add(child);
                    ++created_states;
                    children.add(child);
            ...
            if(isValid(i-1, j+1)) // 8. Check if we can move right&up
            {
                ...
                else if(!set.contains(child) && n.getPath().length()>=3&&!n.getPath().substring(n.getPath().length()-3, n.getPath().length()).equals("LD"))
                {
                    set.add(child);
                    ++created_states;
                    children.add(child);
